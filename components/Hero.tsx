  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        ...
        />
        <Spotlight
          className="top-28 left-80 h-[50vh] w-
        [50vw]"
          fill="blue"
        />
      </div>
      ...
      <div
       ...
       bg-white  dark:bg-grid-white/[0.03] bg-grid-black/
       [0.2] flex items-center justify-center absolute
       top-0 left-0"
      >
        <div
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        >
          ...
          <TextGenerateEffect
            ...
            words="Creativity and technology are the cornerstones of all my endeavors."
          />

          <p className="text-center md: tracking-wider
          mb-4 text-sm md:text-lg lg:text-2xl">
             Hi, I&apos;m Nidhi, a full stack developer, engineer and AI ML enthusiast based in Dehradun,India.
          </p>
